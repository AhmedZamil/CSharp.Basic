...
{
    public class Shortest_Path_Implementation
    {
        public void Main()
        {
        ...
        public void printShortestDistance(List<List<int>> adj, int s, int dest, int v)
        {
        ...
        public bool BFS(List<List<int>> adj,int src, int dest,int v, int[] pred,int[] dist)
        {
